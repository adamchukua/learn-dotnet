...
Версійність API необхідна, коли розробник планує додавати нові функції або модифікувати наявні. Версійність також корисна в ситуаціях, коли користувачі API мають різні потреби в різних версіях API або коли зміни в API можуть зіпсувати існуючі додатки, що використовують цей API. </li>
</ol>
</div>
