...
<li>PUT - оновлює існуючий ресурс на сервері.</li>
<li>DELETE - видаляє існуючий ресурс з сервера.</li>
<li>PATCH - оновлює частину ресурсу на сервері.</li>
</ul>
</li>
...
<li>Використовуйте гіпермедіа як двигун додатку (HATEOAS) для надання користувачам інформації про доступні дії на поточному ресурсі.</li>
